...
export async function createReview(formData){
    const response = await fetch(`${BASE_URL}/film-reviews?`,{method: 'POST', body: formData})
...
export async function updateReview(id,formData){
    const response = await fetch(`${BASE_URL}/film-reviews/${id}`,{method: 'PUT', body: formData})
...
export async function deleteReview(id){
    const response = await fetch(`${BASE_URL}/film-reviews/${id}`,{method: 'DELETE'})
